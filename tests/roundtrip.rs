...
fn batch3_sp2_roundtrip() {
  ...
  rt(&AudioChannelLayout {
    ...
    native_mask: None,
    custom_channels: vec![],
    description: SmolStr::default().into(),
    ..Default::default()
  });
...
fn batch5_sp2_roundtrip() {
  ...
  rt(&Media {
    ...
    error_status: 0,
    capture_date: 0,
    device_make: SmolStr::default().into(),
    device_model: SmolStr::default().into(),
    gps_location: SmolStr::default().into(),
    ..Default::default()
  });
  rt(&Media::default());
...
fn batch8_sp2_roundtrip() {
  ...
  rt(&AudioSummary {
    ...
    has_speech: false,
    has_music: false,
    dominant_language: SmolStr::default().into(),
    speech_ratio: 0.0,
    speaker_count: 0,
    loudness_lufs: 0.0,
    rms_db: 0.0,
    transcript_preview: SmolStr::default().into(),
    clip_count: 0,
    fingerprint: vec![],
...
fn make_audio_stream_meta_mf() -> buffa::MessageField<AudioStreamMeta> {
  buffa::MessageField::some(AudioStreamMeta {
    ...
    album: SmolStr::default().into(),
    artist: SmolStr::default().into(),
    title: SmolStr::default().into(),
    genre: SmolStr::default().into(),
    track_number: 0,
    sample_format: "fltp".into(),
    bits_per_sample: 32,
    ..Default::default()
...
fn batch9_sp2_roundtrip() {
  ...
  let aa_min = AudioAnalysis {
    ...
    description_en: SmolStr::default().into(),
    description_zh: SmolStr::default().into(),
    gemini_scene: SmolStr::default().into(),
    gemini_mood: SmolStr::default().into(),
    gemini_sound_sources: vec![],
    gemini_foreground: SmolStr::default().into(),
    gemini_background: SmolStr::default().into(),
    gemini_enhanced: false,
    event_timeline: vec![],
    foreground_layer: SmolStr::default().into(),
    background_layer: SmolStr::default().into(),
    speech_ratio: 0.0,
    speaker_count: 0,
    speaker_segments: vec![],
    voice_gender: buffa::MessageField::none(),
    voice_emotion: buffa::MessageField::none(),
    transcript: SmolStr::default().into(),
    transcript_segments: vec![],
    language: SmolStr::default().into(),
    ...
    energy_profile: SmolStr::default().into(),
...
fn batch10_sp2_roundtrip() {
  ...
  let afr_sparse = AudioFileRecord {
    ...
    title: "Sparse".into(),
    artist: "Nobody".into(),
    album_artist: SmolStr::default().into(),
    album: SmolStr::default().into(),
    genre: SmolStr::default().into(),
    composer: SmolStr::default().into(),
    performer: SmolStr::default().into(),
    date: SmolStr::default().into(),
    track_number: 1,
    total_tracks: 1,
    disc_number: 1,
    total_discs: 1,
    comment: SmolStr::default().into(),
    lyrics: SmolStr::default().into(),
    tag_types: vec![],
